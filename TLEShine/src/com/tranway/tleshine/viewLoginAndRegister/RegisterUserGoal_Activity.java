...
public class RegisterUserGoal_Activity extends Activity implements OnClickListener {
	private static final String TAG = RegisterUserGoal_Activity.class.getSimpleName();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_register_user_goal_);
	...
	private void setUserGoalFromSP() {
		int userGoal = UserGoalKeeper.readExerciseGoalPoint(this);
		if (userGoal != 0) {
			goalPoint = userGoal;
		}
	...
	private void onNextButtonClick() {
		...
		UserGoalKeeper.writeExerciseGoal(this, goalPoint);
